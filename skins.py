...
def modify():
    ...
    try:
        shutil.copytree(xbmcvfs.translatePath('special://skin'), xbmc.translatePath(destination))
        ...
        if copy_settings:
            ...
            shutil.copytree(xbmcvfs.translatePath('special://userdata/addon_data/' + skin), xbmc.translatePath(destsettings))
